...
# main config
PLUGINSLUG='wp-people-pop' # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="wp-people-pop.php" # this should be the name of your main php file in the wordpress plugin
SVNUSER="MrFlannagan" # your svn username (case sensitive)
